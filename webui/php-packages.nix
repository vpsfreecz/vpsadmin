...
let
  packages = {
    ...
    "guzzlehttp/guzzle" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "guzzlehttp-guzzle-eaa81598031cf57a9e36258c8546defffc994cba";
        src = fetchurl {
          url = "https://api.github.com/repos/guzzle/guzzle/zipball/eaa81598031cf57a9e36258c8546defffc994cba";
          sha256 = "03qcsydflpj9h6hd273zd4l45z1ww7h5zmwcj46xvn5p572fkpas";
        };
      };
    };
    "guzzlehttp/promises" = {
    ...
    "guzzlehttp/psr7" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "guzzlehttp-psr7-172ef2f4e9824c1e058b7f30be8ae25a02c0f2b7";
        src = fetchurl {
          url = "https://api.github.com/repos/guzzle/psr7/zipball/172ef2f4e9824c1e058b7f30be8ae25a02c0f2b7";
          sha256 = "1zypng5zkv008rprzbzygq14rc870yib8c5vv6ra25cqsncf0ljd";
        };
      };
    };
    "haveapi/client" = {
