...
let
  packages = {
    ...
    "guzzlehttp/guzzle" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "guzzlehttp-guzzle-aef242412e13128b5049864867bb49fc37dd39de";
        src = fetchurl {
          url = "https://api.github.com/repos/guzzle/guzzle/zipball/aef242412e13128b5049864867bb49fc37dd39de";
          sha256 = "0bf13m3q68r5zr919hhhzi82y19y53jdcw224jx29ydyw31zspg7";
        };
      };
    };
    "guzzlehttp/promises" = {
    ...
    "guzzlehttp/psr7" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "guzzlehttp-psr7-51e27f9e2b332ab3e72f4520d5ff4f3c68c3577c";
        src = fetchurl {
          url = "https://api.github.com/repos/guzzle/psr7/zipball/51e27f9e2b332ab3e72f4520d5ff4f3c68c3577c";
          sha256 = "11xqaangpx74yqgf3zgq8nwx6ggwm2v3838mlwp1984q32cnkrvm";
        };
      };
    };
    "haveapi/client" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "haveapi-client-57add0e084f7e3f2805736adc791f105a83f52e7";
        src = fetchurl {
          url = "https://api.github.com/repos/vpsfreecz/haveapi-client-php/zipball/57add0e084f7e3f2805736adc791f105a83f52e7";
          sha256 = "08rmavvpj7gns4gh31zdxmvya8j476pc9llqh0skcrdlyc3wk2n8";
        };
      };
    };
  ...
  devPackages = {
    ...
    "phpunit/phpunit" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "phpunit-phpunit-8f5180f4627fc1978be2f61d8d9979dbe37e0c10";
        src = fetchurl {
          url = "https://api.github.com/repos/sebastianbergmann/phpunit/zipball/8f5180f4627fc1978be2f61d8d9979dbe37e0c10";
          sha256 = "0lknhqs8k8inzvj581sbvp7yy9dfp728d1bacqmvfwkv5fdr7crk";
        };
      };
    };
