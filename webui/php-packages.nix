...
let
  packages = {
    ...
    "guzzlehttp/guzzle" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "guzzlehttp-guzzle-c987f8ce84b8434fa430795eca0f3430663da72b";
        src = fetchurl {
          url = "https://api.github.com/repos/guzzle/guzzle/zipball/c987f8ce84b8434fa430795eca0f3430663da72b";
          sha256 = "1ykhmpd6cx2q24w10hjvc81rqxyb0416sk27102kavszmcd6csrq";
        };
      };
    };
    "guzzlehttp/promises" = {
  ...
  devPackages = {
    ...
    "phpunit/php-code-coverage" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "phpunit-php-code-coverage-ab8a36c9bd98c51f6cfe665a732bfadf72e18e8d";
        src = fetchurl {
          url = "https://api.github.com/repos/sebastianbergmann/php-code-coverage/zipball/ab8a36c9bd98c51f6cfe665a732bfadf72e18e8d";
          sha256 = "0c3qz5kkc5chw38av641s3c4xj3mlrxxyirkkk55bswfhp6fhj0y";
        };
      };
    };
