...
function dataset_list($role, $parent = null, $user = null, $dataset = null, $limit = null, $from_id = null, $opts = [])
{
    ...
    foreach ($datasets as $ds) {
        ...
        $xtpl->table_td('<a data-vpsadmin-doc-id="datasets.edit" href="?page=dataset&action=edit&role=' . $role . '&id=' . $ds->id . '&return=' . $return . '"><img src="template/icons/edit.png" title="' . _("Edit") . '"></a>');
