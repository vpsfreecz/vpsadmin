...
require 'nodectld/commands/network_interface/route_add'
require 'nodectld/network_interface'

RSpec.describe NodeCtld::Commands::NetworkInterface::RouteAdd do
  ...
  it 'waits for conflicting routes to clear before adding the new route' do
  ...
  it 'removes the route on rollback' do
