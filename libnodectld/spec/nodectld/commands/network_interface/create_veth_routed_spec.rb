...
require 'nodectld/commands/network_interface/create_veth_routed'
require 'nodectld/net_accounting'

RSpec.describe NodeCtld::Commands::NetworkInterface::CreateVethRouted do
  ...
  it 'creates the config entry, runtime netif, and accounting entry' do
  ...
  it 'removes the runtime netif, config entry, and accounting on rollback' do
