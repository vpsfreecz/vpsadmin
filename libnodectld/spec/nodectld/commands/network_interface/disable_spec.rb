...
require 'nodectld/commands/network_interface/disable'

RSpec.describe NodeCtld::Commands::NetworkInterface::Disable do
  ...
  it 'disables the runtime interface and enables it on rollback' do
