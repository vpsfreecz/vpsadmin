...
require 'nodectld/commands/network_interface/host_ip_add'
require 'nodectld/network_interface'

RSpec.describe NodeCtld::Commands::NetworkInterface::HostIpAdd do
  ...
  it 'adds the host address and removes it on rollback' do
