...
require 'nodectld/commands/user_namespace/use'

RSpec.describe NodeCtld::Commands::UserNamespace::Use do
  ...
  it 'adds the osctl user on exec and removes it on rollback' do
