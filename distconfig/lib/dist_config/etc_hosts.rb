...
module DistConfig
  ...
  class EtcHosts
    ...
    NOTICE_BODY = <<~END.freeze
      # This file is updated by vpsAdmin on every VPS start to configure
      # the hostname. If you would like to manage the hostname manually,
      # you can configure it in VPS details in vpsAdmin. In addition, vpsAdmin
      # will not modify this file if the write by user permission is removed:
      #
      #   chmod u-w /etc/hosts
    END
    ...
    # Iterate over all lines except the vpsAdmin-generated notice
    # @param io [IO]
