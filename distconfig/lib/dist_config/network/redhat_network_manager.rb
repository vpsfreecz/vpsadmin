...
module DistConfig
  ...
  class Network::RedHatNetworkManager < Network::Base
    ...
    def do_create_netif(netif)
      tpl_base = File.join('network/redhat_network_manager')
    ...
    def generate_nm_conf(netifs)
      ...
      ErbTemplate.render_to_if_changed(
        File.join('network/redhat_network_manager/nm_conf'),
        { netifs: },
        file
      )
    end
    ...
    def generate_nm_udev_rules(netifs)
      ...
      ErbTemplate.render_to_if_changed(
        File.join('network/redhat_network_manager/udev_rules'),
        { netifs: },
        file
      )
    end
