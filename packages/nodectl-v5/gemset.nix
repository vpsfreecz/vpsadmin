{
  amq-protocol = {
    ...
    source = {
      ...
      sha256 = "1f3030phzsngyh4pl035sfjcid2832bzskmyair0g3sgaxq2rwi4";
      type = "gem";
    };
    version = "2.5.0";
  };
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "161gfq1vgwc439mv6invr7yysgi1476nz5z89fig0r1455mbr481";
      type = "gem";
    };
    version = "5.0.0.build20260109211612";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1d0zy9dhkvlxfzvh0r0czdcfv7vbvm1j2cbbfh9avf6vrlxz0aqg";
      type = "gem";
    };
    version = "5.0.0.build20260109211612";
  };
