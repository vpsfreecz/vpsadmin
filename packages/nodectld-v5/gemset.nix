{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0cdd8yc8s2cxz2mdxpp611qvzw8kqjlh53n2vhpbz08bz8rckk18";
      type = "gem";
    };
    version = "5.0.0.build20251203102543";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "18isa3ppnc74ly8jx9dggnydzbgnx9mny41wxiax85v5ad0db9s4";
      type = "gem";
    };
    version = "5.0.0.build20251203102543";
  };
