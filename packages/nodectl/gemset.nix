{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0sjmrczjjl4v3hbryf1ipcm9vyg4jiynm98qz709plllqlyibizk";
      type = "gem";
    };
    version = "3.0.0.dev.build20190313091310";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0mji7sza5d2zbn8prnixki9zg13yj2kgz4pn0x0mrr9im1ayiiir";
      type = "gem";
    };
    version = "3.0.0.dev.build20190313091310";
  };
