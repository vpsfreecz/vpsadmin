{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0rsl1idwdm9qzmsyjg2dhl1iv1xf9qfg8d636lb1nvaxlwwiplgj";
      type = "gem";
    };
    version = "3.0.0.dev.build20221124172248";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0y6g303hvipsr52wqq5iwkxhh2ab81ljxgra89qv7dhy2zlfd0ww";
      type = "gem";
    };
    version = "3.0.0.dev.build20221124172248";
  };
