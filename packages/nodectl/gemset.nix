{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1zb5n4sgciadab1mgwiz1ar1f8409jbpsxi259scdwz1y1707vi6";
      type = "gem";
    };
    version = "3.0.0.dev.build20221022194322";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0y44cwdp8m29zbsv9gyp5vffmqnk7dswvg3v4d3qrynac8jfyqx6";
      type = "gem";
    };
    version = "3.0.0.dev.build20221022194322";
  };
