{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "14nyv1kx1zl859ay4y1rgrd26xvwjcqff9kky8rz4hfkmpgpg160";
      type = "gem";
    };
    version = "3.0.0.dev.build20230701122245";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "11a2bhhaq46z5nmaq6b5wfasl5nan62dyxdpxdpxrf88r11n548f";
      type = "gem";
    };
    version = "3.0.0.dev.build20230701122245";
  };
