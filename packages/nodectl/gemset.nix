{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1zkx7xcl603igadd9yd7l418dszmkg9crld7yawzhb5a1x48z312";
      type = "gem";
    };
    version = "4.1.0.build20260517135049";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1f5jb69r49l8p7n007mic5jbskgpr7a4cdgwk46hxksy2p92shhq";
      type = "gem";
    };
    version = "4.1.0.build20260517135049";
  };
