{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1y52772y7j8yi6nqbg3ck31fq1afvldmcdcj8lqajy33mvmh961w";
      type = "gem";
    };
    version = "3.0.0.dev.build20181022141806";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "04is63mzxqxr1mcsj1q9hm9xwg655xr36v3ysj4z680zp3ralzaq";
      type = "gem";
    };
    version = "3.0.0.dev.build20181022141806";
  };
