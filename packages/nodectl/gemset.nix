{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0lasp5ngfgf51abffljh1s5xvmai9iqq9rz7713rj1i6wa7h2jsm";
      type = "gem";
    };
    version = "4.1.0.build20250625174806";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1v08299ximp2ji0vc2i2r8m6kjdx0ssivlkml930kpgs5vx78vka";
      type = "gem";
    };
    version = "4.1.0.build20250625174806";
  };
