{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0708m75861gdjj9s7w7jpy9k6qwkngpm9dvrqv8xc6ni5kssj4xa";
      type = "gem";
    };
    version = "3.0.0.dev.build20230221172343";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "17l4rmdyyfsl40d0f544gw4pdmjngnc9yw37rr042kjw6mva5g8c";
      type = "gem";
    };
    version = "3.0.0.dev.build20230221172343";
  };
