{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0v4hgciv95q50ck2b8glcqxwq3sjix2wbfv9nv985pkmd6gl28gg";
      type = "gem";
    };
    version = "4.1.0.build20260516164724";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1x8irvwydc8mz6wfp3mk0g0073fc5ws48m0z1h0py1dbxmd14f1x";
      type = "gem";
    };
    version = "4.1.0.build20260516164724";
  };
