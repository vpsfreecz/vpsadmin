{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0h6v2x9qv48vv1rhb4v7b6l45mf5k4yfs6pvc5jrihx8rx7nkjg7";
      type = "gem";
    };
    version = "3.0.0.dev.build20220401200825";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0dkdwh8g348fjrnp4j69h6ljx6w5jajijqc2a68cnnjyb0251h99";
      type = "gem";
    };
    version = "3.0.0.dev.build20220401200825";
  };
