{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0yc4gz95q5wm8an57wbxi4ji22cijn57dfdg6jx8q0djsf4y1ahm";
      type = "gem";
    };
    version = "3.0.0.dev.build20231107180205";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0n79q6pc5ia2dw06l255g9a7flpffwv9cngpsw9j5qnxid4n7fsg";
      type = "gem";
    };
    version = "3.0.0.dev.build20231107180205";
  };
