{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1mxn74a34cgg897mifd18k57kbnb0yy9pzgr6dknkrk6z5zmsa9m";
      type = "gem";
    };
    version = "3.0.0.dev.build20230630090920";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1zmkr9dybsibv9hxhadykikig5rzk7zbrv21kjzpacyqj8fzmr5i";
      type = "gem";
    };
    version = "3.0.0.dev.build20230630090920";
  };
