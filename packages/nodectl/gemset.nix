{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "093z8l6w368ca0xv1cscvhwvyin9lsmad62yvl5qkdy06ld34i95";
      type = "gem";
    };
    version = "4.0.0.build20241124114502";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "07r4fhdr0zgr55adh3n9knybzwrvb4r3yd62rf8n9bml7wbrf1ik";
      type = "gem";
    };
    version = "4.0.0.build20241124114502";
  };
