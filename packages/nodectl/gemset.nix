{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "115plxj3333krrdhbgylkf1i4b0h95az4asqsmwvdislzancnkfh";
      type = "gem";
    };
    version = "4.1.0.build20260525124552";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0h4b9r700c6hysv1xymsvd6q4rfwmifvjcja7n2affkkpxf0sn4g";
      type = "gem";
    };
    version = "4.1.0.build20260525124552";
  };
