{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0xx7lzh4445p6pszk0czgwcp307sy3ihgwiraljv3q6z0p573imk";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092548";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0b9hqh3kw0wy7y3cmn02wvcrgb6zr2sgy8abvnm2daisg9axv1v2";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092548";
  };
