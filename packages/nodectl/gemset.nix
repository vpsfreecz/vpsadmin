{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0nfkzrgd89k80as80yxm0rradvq8bl6ra5nywvibk904jlkp1mgm";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092053";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0p73y4fwpnfk2b3pnh9zifz662jvn609xla7i328hqxishmac418";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092053";
  };
