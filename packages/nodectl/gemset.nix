{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0rld8894p597f42qdv5mvfrpprql4lav28ajqh5yrjw8w0dwb1zh";
      type = "gem";
    };
    version = "3.0.0.dev.build20200708170112";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1kinjqpz2jaz9sxhzqbq6l08npvxg2zs1mf61c8498mzs0ycx18n";
      type = "gem";
    };
    version = "3.0.0.dev.build20200708170112";
  };
