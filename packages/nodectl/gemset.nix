{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "145rkvnwg5vv5sj38a8brgpa98nayqf6q6izfhx5anifqqbnnd34";
      type = "gem";
    };
    version = "3.0.0.dev.build20181031151148";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1smxvz1fmxn4jlvzq27yrmgg3m6kg9zrq93fljgdha28zppr4mg1";
      type = "gem";
    };
    version = "3.0.0.dev.build20181031151148";
  };
