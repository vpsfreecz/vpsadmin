{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0r7r76vawh9mh0xp1kika2ckrlclrx2lqclynn5qikzvh0hgl7md";
      type = "gem";
    };
    version = "3.0.0.dev.build20220812095829";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "07v3yhrc6q47b5cz661qr4kg3vlypn0b8icsqiylagrxzyrrmh7b";
      type = "gem";
    };
    version = "3.0.0.dev.build20220812095829";
  };
