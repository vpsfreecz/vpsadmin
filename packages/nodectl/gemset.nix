{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0ngxpqh21b3qs16ym665g8lhmakl606gp4m0hyi380vwhplvn74s";
      type = "gem";
    };
    version = "4.0.0.build20241029174551";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1rgcaipgyvp9860hf91w8k5nglwhgpbm4r3cfx8rq2ppwgxcyxhj";
      type = "gem";
    };
    version = "4.0.0.build20241029174551";
  };
