{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0w6rcvy9l3lhix8kahwpfxgf65pq1ndhy53c9cn6k5lin8sxk1ki";
      type = "gem";
    };
    version = "3.0.0.dev.build20221220160717";
  };
  libosctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0vvdb73n8cjaqzf3fvshnzjs1n4dnnv7iszrg5vzxfh7cp1fhmck";
      type = "gem";
    };
    version = "21.11.0.build20221124171621";
  };
  mail = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1pdj6pj210phchck98bvvs3b9qpaysaqys66zp5mn73gsq257sbi";
      type = "gem";
    };
    version = "3.0.0.dev.build20221220160717";
  };
  osctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0garm0jfbg2bcanz5y3cpjla8xw37rffq4s55hzjm8ndrgfwr8m8";
      type = "gem";
    };
    version = "21.11.0.build20221124171621";
  };
  osctl-exportfs = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1rys5pqs95ag8avvpa8pqnwg2h31n9kw900izk73jxv98p9i0afv";
      type = "gem";
    };
    version = "21.11.0.build20221124171621";
  };
