{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "07qfkfm98k9a1xg7z1prl2zj55cxsnbzljkk71q14lk7b9l818zs";
      type = "gem";
    };
    version = "4.1.0.build20251201180931";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0v15awz658bv1c6mgg4zlq2wrg1myr6nqklw1a75pas8mn2yiy8b";
      type = "gem";
    };
    version = "4.1.0.build20251201180931";
  };
