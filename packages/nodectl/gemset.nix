{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1haw494im0l5rvigy1a7wqncj0mvzf2icvngzihyybf79jx1147l";
      type = "gem";
    };
    version = "3.0.0.dev.build20230116133903";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0rk1rh8gwn7lv43vysa25ll63qhj2win77hldbv054mamm4y2642";
      type = "gem";
    };
    version = "3.0.0.dev.build20230116133903";
  };
