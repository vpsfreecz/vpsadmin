{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "18kph71y4li8yykjjz73qqa0g6v5mmijr5cxg516xri3i4bdyw48";
      type = "gem";
    };
    version = "3.0.0.dev.build20210825193759";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1sfy7kwz3c34c1lwj71f8vmxwyh70izgik8qgzicd6ij0cnjjhj4";
      type = "gem";
    };
    version = "3.0.0.dev.build20210825193759";
  };
