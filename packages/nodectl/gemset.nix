{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0wyp12m34xrz8iw5cmvm9n72i0fi43bq48z1jjnrb5aycvj2cx9q";
      type = "gem";
    };
    version = "3.0.0.dev.build20180510165911";
  };
  libosctl = {
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1yg3i0zsdzr4p325c23fhwslsm05zgb7xihx7fkklzxfdb8v239f";
      type = "gem";
    };
    version = "3.0.0.dev.build20180510165911";
  };
