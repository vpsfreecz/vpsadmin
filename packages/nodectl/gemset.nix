{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0jzj1szh5pl0f5yciaxp44j0wd225zkgs9jdx041xxmp0lnvragp";
      type = "gem";
    };
    version = "3.0.0.dev.build20221214101555";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1xajy9jks8a8lm4ijhwf0hr5n0kb780xyxvn25nrzbfbg11rcwnz";
      type = "gem";
    };
    version = "3.0.0.dev.build20221214101555";
  };
