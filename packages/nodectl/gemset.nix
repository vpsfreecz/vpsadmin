{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "08r2l93z22fqqlg6572liws8si3fd1hzw1azbs7nn6bzr3ac2rpi";
      type = "gem";
    };
    version = "4.0.0.build20241021200810";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "02xrafrq3d0hjxkh30wzkbv4fsdimqgkqb56djr43m7yxqa0y1n5";
      type = "gem";
    };
    version = "4.0.0.build20241021200810";
  };
