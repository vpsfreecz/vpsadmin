{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "02njpzngq3xrz5d8vdrsjxwwiiclbvjd3b8jqvhwr76dkrjh0y9k";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092603";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0j1z2vrvhqyi13g44v46fpqpzlmzr7vk5hn7pkdg665dhgpjph0k";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092603";
  };
