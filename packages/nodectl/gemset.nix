{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0v7fsfdx06vkpy7n5a8z4dkzlgmxhq4gcbmx8yvs8jh3mkr4vaq7";
      type = "gem";
    };
    version = "3.0.0.dev.build20230123174131";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1snwahwwc7lfizkplwswjwq63mfjpqy0r1mpriv1w3pfy15gdkyg";
      type = "gem";
    };
    version = "3.0.0.dev.build20230123174131";
  };
