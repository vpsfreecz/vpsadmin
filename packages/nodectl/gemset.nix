{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1q0jca0s8g79mgl8ni8h6yaxkn14qw5milyxs0zym2wvzr6yh1ig";
      type = "gem";
    };
    version = "3.0.0.dev.build20190914180229";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "071x9fd7x4l0j5ig5qc332dqh9nn2mrk0i7n1ypn617ks6kzd2w3";
      type = "gem";
    };
    version = "3.0.0.dev.build20190914180229";
  };
