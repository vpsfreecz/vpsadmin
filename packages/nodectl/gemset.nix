{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "053pw6l7h65drn1fqq6s6y42szjbkp9wwsm2k792vxmv2wjzf1gy";
      type = "gem";
    };
    version = "3.0.0.dev.build20200710205221";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1w9wz7fwipvjsa23nmid9iya5zglxanphana170hq9qrgxlznpqh";
      type = "gem";
    };
    version = "3.0.0.dev.build20200710205221";
  };
