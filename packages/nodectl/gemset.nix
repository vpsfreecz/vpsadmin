{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "145g74v2pfs3q1rn1ks042ry60rza0mp11p3hj9cggicddzwrpyg";
      type = "gem";
    };
    version = "3.0.0.dev.build20221120202458";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "01slf59izfiwjqv1a4d0856ikps9r01i7ylarsfzkbwgziyswv3w";
      type = "gem";
    };
    version = "3.0.0.dev.build20221120202458";
  };
