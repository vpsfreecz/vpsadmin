{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0hn5qy5z9vliydnawvqm87kjxvfz85q2xavs2z9iinnp7zlq1bvp";
      type = "gem";
    };
    version = "3.0.0.dev.build20181105082306";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1qgm75ihy1vmjnfll045r1vwhi981chpcpwli9q2khrb6j54rb7r";
      type = "gem";
    };
    version = "3.0.0.dev.build20181105082306";
  };
