{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "01kxgc1a750x86sykawdngz29aiazgrmzxlrvqrw7jpzpnm417bj";
      type = "gem";
    };
    version = "4.1.0.build20251011165814";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "151l51sns8l7sxlyqsr2hwxn670v2nrcykhgljfxlacnh4wdd6p0";
      type = "gem";
    };
    version = "4.1.0.build20251011165814";
  };
