{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0bw5kpfpk3294k909j2qn446x7r7zycjapbm9yzyszp2lzki4xlv";
      type = "gem";
    };
    version = "3.0.0.dev.build20181031160305";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0rah7r1jcl36c5ayw24c506ay8673mb07sgr60li27v52h4wvkvy";
      type = "gem";
    };
    version = "3.0.0.dev.build20181031160305";
  };
