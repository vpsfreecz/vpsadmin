{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1gbigh9zhwn5gygmm86arpsys0p9qpphn5jj8ngrdkwqn122miwp";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092626";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0wvxh2a4knlrscifchn7vb9agzfnc47zz9pagbfv8vbb37pzgh3q";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092626";
  };
