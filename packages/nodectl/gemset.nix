{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "18qnh8mm9bywd6z7sbnqw38y3c4sf5288cla8cjav73yx5z6km2l";
      type = "gem";
    };
    version = "3.0.0.dev.build20221005151006";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0yyqz0flcfzimajhgj562y6scwnndjcz9izpq25md1pwzgc17mm7";
      type = "gem";
    };
    version = "3.0.0.dev.build20221005151006";
  };
