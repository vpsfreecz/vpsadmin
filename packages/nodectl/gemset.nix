{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1cv301b6dap5qx7gxw61rwfxb040fmscpjh5apiv415xw6mv6r92";
      type = "gem";
    };
    version = "3.0.0.dev.build20181104094002";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1isqz6j8ia5wc4lvk2wjbrzzrxxk0m0ac1nz72ix5z4byz8sinwh";
      type = "gem";
    };
    version = "3.0.0.dev.build20181104094002";
  };
