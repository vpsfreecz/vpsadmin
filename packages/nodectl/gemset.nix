{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1xhzvjqiq9yk1m86ffw9fkkrfjpvhh8nq0lq8va34w6bq0klf6kw";
      type = "gem";
    };
    version = "3.0.0.dev.build20230911180242";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0pdz8fvlkh8ywy5mv6fix4zy33f4aa1k4hiq07g63fz5jdb5nrxr";
      type = "gem";
    };
    version = "3.0.0.dev.build20230911180242";
  };
