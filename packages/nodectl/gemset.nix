{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0wv6wg2xip9lqqwfwdmkkl1xb59nlj10garcs93wgw9d89ciwdkq";
      type = "gem";
    };
    version = "3.0.0.dev.build20200811161532";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0ff5njhznq1z9sn2wid2n9ca0a8fxw5rk0x02pzld2cdxy6zw327";
      type = "gem";
    };
    version = "3.0.0.dev.build20200811161532";
  };
