{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1faizf68wib9brkm7blnxk36qkiixj322nh47zl1kyabnbqhs699";
      type = "gem";
    };
    version = "4.1.0.build20251006090125";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectl = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0dp5hllgz6y6kar9y8zyxb2xzg0d4lj1arpmnx7prqpsz62i5knc";
      type = "gem";
    };
    version = "4.1.0.build20251006090125";
  };
