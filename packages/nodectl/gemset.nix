{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0jy7ihq48ka45fv2p0qbgx5lrwzdablhajas7lzbp24gpxp5bgxj";
      type = "gem";
    };
    version = "3.0.0.dev.build20180705101138";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0dv2l9x1360gz7zlx6hb2ybi8qjalb9615sm1fyzpzs85c7hq8j4";
      type = "gem";
    };
    version = "3.0.0.dev.build20180705101138";
  };
