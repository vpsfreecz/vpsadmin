{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0hlg8m4b84r4nfi49jcjilkan51ypv4vfzr7nw36g1wm374fcy40";
      type = "gem";
    };
    version = "3.0.0.dev.build20230910134310";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0xmy72ixxqj2sbn8vzsbnv0prqwky46nf8f6h6clnkdp0hwmgi12";
      type = "gem";
    };
    version = "3.0.0.dev.build20230910134310";
  };
