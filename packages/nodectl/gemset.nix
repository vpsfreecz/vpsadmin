{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0y26mgkk9134vhrik9jvjgdwmnrlwjwc3xkanxbkm60zwfwak49p";
      type = "gem";
    };
    version = "3.0.0.dev.build20180919190451";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0176vxc4ygq3ii585q8znph7xwb557h65lw16wmqf09hqvrs1n85";
      type = "gem";
    };
    version = "3.0.0.dev.build20180919190451";
  };
