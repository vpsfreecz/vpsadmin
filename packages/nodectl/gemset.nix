{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0lb5lw8kyyclq48c2nhzz56dwshya8am7lmvm0sl9cpdp5qsqifr";
      type = "gem";
    };
    version = "3.0.0.dev.build20181031154028";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0z60gzj4qvyjgd415x9hr931klkkgs06jxm80g7l6s93xhp54gn1";
      type = "gem";
    };
    version = "3.0.0.dev.build20181031154028";
  };
  osctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0i3gxlhjvs7xklcq979znax6zvwvcjq0rcirccpabazfyyw6zf0k";
      type = "gem";
    };
    version = "18.09.0.build20181031150503";
  };
