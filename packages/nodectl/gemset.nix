{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1c9q8gf8iiwnqghsvys6mffayc8r2f0cdwvb063y0js6qzfzncdp";
      type = "gem";
    };
    version = "3.0.0.dev.build20180518094752";
  };
  libosctl = {
  ...
  nodectl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0bfcqyxygpzpi8b5gm8x0vkj2b723h4vak04br99654chgichy0q";
      type = "gem";
    };
    version = "3.0.0.dev.build20180518094752";
  };
