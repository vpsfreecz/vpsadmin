{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "10fz8dzg2i58nb4ancvkib9l4zf5ll0qz6xf0hdx16bysvrfkgj1";
      type = "gem";
    };
    version = "3.0.0.dev.build20210504092003";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0d3242scrvwal6r8xgn8x5fx0hfkhmb47h35mfb022ibi7v7jj67";
      type = "gem";
    };
    version = "3.0.0.dev.build20210504092003";
  };
