{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0njwchhxfvi7kkkmi2p80a5gw2bqik4pxfb1g55fyh6h53ca8r0r";
      type = "gem";
    };
    version = "3.0.0.dev.build20200811163817";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0wwil9mvsbhgzikyh2x93gh7pa3yr9fwp8rkdxrwqf8lnwrvnv9b";
      type = "gem";
    };
    version = "3.0.0.dev.build20200811163817";
  };
