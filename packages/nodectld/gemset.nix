{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1dzfjs4rsdg34yrlzs81r1cpn3jjayxxf2d8bhav42ghyy7pw8w1";
      type = "gem";
    };
    version = "4.1.0.build20260402223522";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "05b399xd6ycv6rgkss75pr1j4sm4clqkwsfhwfilxa3m4mj832li";
      type = "gem";
    };
    version = "4.1.0.build20260402223522";
  };
