{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "00sawrhwv0q2b8r5k0sq54098cfzmh6phxz6cjs57ca5pnml92cx";
      type = "gem";
    };
    version = "4.1.0.build20251229161516";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0sh5031fzikvv2h774wpdyvyh73hifbgyc9hqk0a610hsrlazip4";
      type = "gem";
    };
    version = "4.1.0.build20251229161516";
  };
