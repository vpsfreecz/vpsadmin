{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1c691zbcwinxqwc6z6ahwb72yk7kalzznl877kil6sj34lqknx59";
      type = "gem";
    };
    version = "3.0.0.dev.build20200128140939";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1f8fnh8001d60ngd90k1i3f6g3vzi2y29j5kpyfr4bbai8rxbqhg";
      type = "gem";
    };
    version = "3.0.0.dev.build20200128140939";
  };
