{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0r8nrfpad3clpvp4gr50n2ybf7z42wm3r47nzbhy5qnridzq6z35";
      type = "gem";
    };
    version = "3.0.0.dev.build20230411110426";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1dxipi071ayx3fyvxhwp0qv4c61fw7x4shs21qq37w0wknkd1d8v";
      type = "gem";
    };
    version = "3.0.0.dev.build20230411110426";
  };
