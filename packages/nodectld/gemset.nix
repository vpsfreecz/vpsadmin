{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "090dlrlxcfckra8vm3xc1da9x1068pbp7mfrcxnb4r8w85ayca86";
      type = "gem";
    };
    version = "4.1.0.build20260515222819";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "045j0ybdyyprv56k6119izf6x4yw6dv22bkp9qhd62rkncwlhcdg";
      type = "gem";
    };
    version = "4.1.0.build20260515222819";
  };
