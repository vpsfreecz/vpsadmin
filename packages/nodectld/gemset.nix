{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0y6zm1p7hvrl7d2d89xnpawxrhxpj8ifwzzsscrkl17nsf58qylk";
      type = "gem";
    };
    version = "3.0.0.dev.build20240811095818";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "034909fy9fqm0gzz5xfpdp8mnl33l3aq7gm1i6bg4jjp16yv62pl";
      type = "gem";
    };
    version = "3.0.0.dev.build20240811095818";
  };
