{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1p2kbwkvz743mr2802r34idz7bby2iwsfp2lz6majyiqsfwmqjfs";
      type = "gem";
    };
    version = "3.0.0.dev.build20221124125611";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0aqhc33jmsx1v47mysm0vyxs8rmv0gsjwm4cy6px2wqmfv7qj9vg";
      type = "gem";
    };
    version = "3.0.0.dev.build20221124125611";
  };
