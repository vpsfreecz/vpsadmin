{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1p0f07725fi0jx6jw079w4p129l2si8x5x1s8vvm8xpkl9pgfkd7";
      type = "gem";
    };
    version = "4.1.0.build20260531233821";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "14c48zhw43sjvi7b6zglw0w1v9b6g9c6f8w33z58agnwxlxk9ssi";
      type = "gem";
    };
    version = "4.1.0.build20260531233821";
  };
