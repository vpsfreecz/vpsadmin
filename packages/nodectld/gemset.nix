{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "06v6pxcr8g5g1396a4bvvhlp93fc3sdpipz1w1s0n7mxhnv5ckpj";
      type = "gem";
    };
    version = "3.0.0.dev.build20221126175130";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1d49yrya07vp4pw77dgl5psg11l3l5ax995s3rp8x3lq57fkan6d";
      type = "gem";
    };
    version = "3.0.0.dev.build20221126175130";
  };
