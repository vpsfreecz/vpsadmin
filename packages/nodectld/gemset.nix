{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1c8s4nflj69lry312nmja8qvgyqw959yyn5j6mc47sf8j7h1ghvz";
      type = "gem";
    };
    version = "4.1.0.build20260401152554";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1xdkibx74s0figqb4vxxwm3rp9gscgy52l13ns5pn9ab33cf39xr";
      type = "gem";
    };
    version = "4.1.0.build20260401152554";
  };
