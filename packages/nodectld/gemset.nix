{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "02spr9hxs6b9bry9p3fgdckpm43c3np9ryk2nbljn1xwnhckpn8a";
      type = "gem";
    };
    version = "3.0.0.dev.build20210826130354";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1qcva8jvw7nip8qinbaycsdd0g0hajm6hjiylhdyfnyqb0i20gdb";
      type = "gem";
    };
    version = "3.0.0.dev.build20210826130354";
  };
