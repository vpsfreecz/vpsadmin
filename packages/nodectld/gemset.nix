{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1yyzvqs0gs0mlj35rz662q71lqaggzvz36mi4zq9bygp3v3b3mm3";
      type = "gem";
    };
    version = "3.0.0.dev.build20221024173035";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "19xq81dvl5f9dq09gypw2daz7cr3rx405vf6d4sb46kf24azri7a";
      type = "gem";
    };
    version = "3.0.0.dev.build20221024173035";
  };
