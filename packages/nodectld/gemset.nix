{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0awvglylk0k703frsmhlrxvwx6mk6l7n6l1qmj0p2wh1k7h1xfh8";
      type = "gem";
    };
    version = "3.0.0.dev.build20230119141420";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0nxpbrhalvijd3clwa6hq91zl77cwzpi97f7jz89vyc796wxp52j";
      type = "gem";
    };
    version = "3.0.0.dev.build20230119141420";
  };
