{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "19xskllvzz8x1b8xl8xqb6xg0d23i4z05gj10d7c95i09arw2k0f";
      type = "gem";
    };
    version = "3.0.0.dev.build20200319191547";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1d79bmb7gf20byzzbhi8zzmy6ifiy7h9da62fzsiylmldwqywzja";
      type = "gem";
    };
    version = "3.0.0.dev.build20200319191547";
  };
