{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1ib7y6n30lb479m833xaq7lyz5xfhiamf07s4z8lj23aph52nh22";
      type = "gem";
    };
    version = "3.0.0.dev.build20210828191616";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0z6vbgm6xilgmr8pxsac1h0zpah8z4vl47icpsr0kw3r7gjjv1d6";
      type = "gem";
    };
    version = "3.0.0.dev.build20210828191616";
  };
