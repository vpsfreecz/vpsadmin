{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "016nl1f6m33lj75dv92640qgm0wsha4b10xjz9dvnwcnqj4fi69x";
      type = "gem";
    };
    version = "3.0.0.dev.build20181120175308";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "072qxbhr14w1vfaa7shh12fvmq9vxzliw1w8psa7brqy0n413nfg";
      type = "gem";
    };
    version = "3.0.0.dev.build20181120175308";
  };
