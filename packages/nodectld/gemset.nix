{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1j4qrsvpkmyx3xbxl2l46ijys88ncd3f3bp3gag6iz0bxcsv6xmw";
      type = "gem";
    };
    version = "3.0.0.dev.build20190313091335";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1z5y64j8aj7v8gklliqprv1ldpdakzcifjn1dp5g2z6xsb822iwx";
      type = "gem";
    };
    version = "3.0.0.dev.build20190313091335";
  };
