{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1wmhjsqynxqbx2bmx4xbxn6irfbcc8xipv1kv20aj5mivkspj39n";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092522";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "19f472nbq8k4nqk7c999qid0ka16hgdk2grj4qg009r47wc5cg4d";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092522";
  };
  osctl = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0gvvkza0p0cyypkzz8j46jv65cwfw3cr8ridr7idds8j3mkpb2qg";
      type = "gem";
    };
    version = "18.09.0.build20190403201923";
  };
