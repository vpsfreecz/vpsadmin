{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0s4v6nhnrin87nnwcxgqr7w4ppav7mdr4pqf0v6v3rf81pjd5rdm";
      type = "gem";
    };
    version = "3.0.0.dev.build20201021184044";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "06l7539qzhv6f15p9zqvgpvsc97p7rlfmma4spwdynz6ivhfchri";
      type = "gem";
    };
    version = "3.0.0.dev.build20201021184044";
  };
