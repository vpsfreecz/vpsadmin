{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0pcg23xczvi0431cgk3fmd8m7yl9sy5q5aypvc6xb0fhmp8j1hbi";
      type = "gem";
    };
    version = "3.0.0.dev.build20230124171147";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "15h61qjdn2ff33axcjzzld4bkg2s2wj0ncwf2b2dkk5g8fmk8z0x";
      type = "gem";
    };
    version = "3.0.0.dev.build20230124171147";
  };
