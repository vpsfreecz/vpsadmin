{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "04db2kbymz2q1dfk9bnjhhdmi67kbk4rwrxny8iswaszvrinycl8";
      type = "gem";
    };
    version = "3.0.0.dev.build20221022201357";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1cksan8ky8zvmjbawsybs15mw9gxz1hn3vyycg8l1la92w3s542r";
      type = "gem";
    };
    version = "3.0.0.dev.build20221022201357";
  };
