{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0ri0552mdh4dm8a1h8bsificamdwrqk82calfdkp7dqi9s8h9wfy";
      type = "gem";
    };
    version = "4.0.0.build20250305141725";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1pl10cyyidn4y66c8i359mmwwj182fwp0z9qim4ldvjdj0j7ypi5";
      type = "gem";
    };
    version = "4.0.0.build20250305141725";
  };
