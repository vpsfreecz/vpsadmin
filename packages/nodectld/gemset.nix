{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "084vz5zvmwqwsbklg72ndb6af5yjsl7d4di90xjagkhclzjnn59y";
      type = "gem";
    };
    version = "4.1.0.build20260411174340";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0zlx6pgr4l1n04jb50mnwxjmc59974rfjgmr6s1dqddjn9wmmg1f";
      type = "gem";
    };
    version = "4.1.0.build20260411174340";
  };
