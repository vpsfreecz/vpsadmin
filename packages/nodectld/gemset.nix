{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1j8myajfm03y55qff6k3906cfz761swmxmg5j2g5b6lxysis48qi";
      type = "gem";
    };
    version = "3.0.0.dev.build20230802130939";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1r15rawxr5510i5ib81z5mbdii2w0f8bbmfh276jn02bjmxriw41";
      type = "gem";
    };
    version = "3.0.0.dev.build20230802130939";
  };
