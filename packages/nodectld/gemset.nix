{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1hixsx4w1dhsc25wddw8a1zdx57qkzr2gkv6f7fwy4j2j68kv4fq";
      type = "gem";
    };
    version = "3.0.0.dev.build20230422164617";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0ccdsh35ihg4ng0gh6ck0z2fjq11nvvywnxpd3isgxigyzmybd7y";
      type = "gem";
    };
    version = "3.0.0.dev.build20230422164617";
  };
