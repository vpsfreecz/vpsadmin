{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0rxa12gx96k6dk9psz8lj38h27p78jq3dgy02din9q7vaqj72wjf";
      type = "gem";
    };
    version = "3.0.0.dev.build20221113110426";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "13rq6c4bwh6f7f7h6xkfqb7bcxdr5y1zhf6agvkjbpl2vvd3barc";
      type = "gem";
    };
    version = "3.0.0.dev.build20221113110426";
  };
