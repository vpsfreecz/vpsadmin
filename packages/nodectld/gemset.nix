{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1an47iw1gnmid7p0g3pcg7c9w052zjf2gvb6ydvj78k1d65yv9ng";
      type = "gem";
    };
    version = "4.1.0.build20251211085216";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0zx1xpa1ns5gdmpb3a3zy2khyi87llsm0ghm0jcnck0ijqsxww5f";
      type = "gem";
    };
    version = "4.1.0.build20251211085216";
  };
