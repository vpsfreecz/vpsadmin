{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1dy641c7mxbmd5pfi735m4y55jdch4grqbrapri66n8aawnawgjb";
      type = "gem";
    };
    version = "3.0.0.dev.build20220929023924";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "185a0zslgpdagydw1yph4mc8s8q6vq5d9d4n1z6753bzjb5xgib8";
      type = "gem";
    };
    version = "3.0.0.dev.build20220929023924";
  };
