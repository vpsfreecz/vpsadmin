{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1n4p6m9zbncp2qk7m5wz2mz4apl7kfcvxlg4wk4s0zwgc6n7wip4";
      type = "gem";
    };
    version = "3.0.0.dev.build20221023153831";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "17hyaqgw7gr9pan65zkmsyi5q3bbx82vjh2jp7hfvl5yh99kg5x7";
      type = "gem";
    };
    version = "3.0.0.dev.build20221023153831";
  };
