{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0xn622kxs230q2fd3xd9h13nicrn2bxrs2jmj8rngsp2vaw865fg";
      type = "gem";
    };
    version = "3.0.0.dev.build20220421112259";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0nl3wdjgpnc2pyrk9r3y1pd6my182bl68309iqq4pbm17qz5jlx4";
      type = "gem";
    };
    version = "3.0.0.dev.build20220421112259";
  };
