{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1ssci55lwnih0wrmi6bzwi3piyw2pn3mwshypz99phhz63lsw4ly";
      type = "gem";
    };
    version = "3.0.0.dev.build20190608160723";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0lkj7hb0dr6692m8caiym1l4d3p7m3jy2g1izw0pv2mwvr8zg1c4";
      type = "gem";
    };
    version = "3.0.0.dev.build20190608160723";
  };
