{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0p6ngih408l0vr49isrlpl9w1kn4kxdvml32apdmx65qf7y9mba2";
      type = "gem";
    };
    version = "4.1.0.build20260531174549";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0yhy4kckj1c6ig5x7svdbifnqlqakq9yai43jfbr4xhkvw4hs4n5";
      type = "gem";
    };
    version = "4.1.0.build20260531174549";
  };
