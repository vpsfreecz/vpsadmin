{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1idnljnq51sra6mrkqjh6h5677cqpndxrq3h39fa30zh7n2sw1w3";
      type = "gem";
    };
    version = "3.0.0.dev.build20200312211814";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0bw2mfiqq2kkjyrg5kgka4nhk67j6x0b4pbpjm7x0ysrlxw1g0ph";
      type = "gem";
    };
    version = "3.0.0.dev.build20200312211814";
  };
