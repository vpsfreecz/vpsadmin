{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "017i3x5wwrk211i2yxvivsy8iqw9s35v2hsfqlm6832zsfmdzwhk";
      type = "gem";
    };
    version = "3.0.0.dev.build20200707222224";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "10v2bjv1366xiir04fahzy8l6n41k9k3pfzycfqra5wcjmcv3cjb";
      type = "gem";
    };
    version = "3.0.0.dev.build20200707222224";
  };
