{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "1ybry7pffgkdr68ljwszgnx0w32ikawyc0ssy53ny1a847b6bs0c";
      type = "gem";
    };
    version = "4.1.0.build20260518164821";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "1rq3sff7k3blbvrgvxs7qvvx04jw51zy49bwq5kajq4fmirmgn1q";
      type = "gem";
    };
    version = "4.1.0.build20260518164821";
  };
