{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0x750xyhds2b0337ay63nzldd1n2zdwgi2w5gjdwmzcm8vrdkkbn";
      type = "gem";
    };
    version = "3.0.0.dev.build20231016165040";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "16c80x6vh8qpxv7jj95c04dqzgjblpq4szqfycp5gzswknw8mfmk";
      type = "gem";
    };
    version = "3.0.0.dev.build20231016165040";
  };
