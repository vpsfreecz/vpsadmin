{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0ph99j700qd1xaykdsiw2fx70f6l64y4vhikxijdgbgqs04km24g";
      type = "gem";
    };
    version = "3.0.0.dev.build20230616125759";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "18dgivvy4j48529dn3h9rlbqkgrxm179bsnqdsbrk5fcw957azqz";
      type = "gem";
    };
    version = "3.0.0.dev.build20230616125759";
  };
