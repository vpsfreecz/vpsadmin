{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1hw0yrah6p9zjwihq0i1p3khxwhqadidr4y2czqxyrd7zld85xip";
      type = "gem";
    };
    version = "3.0.0.dev.build20230213140024";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "13n68rh1w9xxfp2qskiy5sikxvqd2fahcrzxv59bb88c97qzrvqb";
      type = "gem";
    };
    version = "3.0.0.dev.build20230213140024";
  };
