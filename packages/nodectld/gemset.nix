{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0ci0nm230l6myfcyv1cldfag6nq2dl0c5p4scgba43r1q2m5lqrp";
      type = "gem";
    };
    version = "3.0.0.dev.build20220927174451";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1dan85lykmh5qs45mscyllwb6s83zg7qzl6s91lhaif0kmcg9b9y";
      type = "gem";
    };
    version = "3.0.0.dev.build20220927174451";
  };
