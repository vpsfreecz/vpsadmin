{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "069g31cm306ll50ar7zqv69hlp13fg750l5x4z91321i4i53y3zp";
      type = "gem";
    };
    version = "4.1.0.build20260527231221";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0j4syhy7px8n1n5si1g06gz9rqwdac38lrapnl9x0zl3m75cdj47";
      type = "gem";
    };
    version = "4.1.0.build20260527231221";
  };
