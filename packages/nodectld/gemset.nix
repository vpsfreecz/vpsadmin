{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "14qdvfhikmiswvjjvvqyw8zmw2d4rr53flpwbd5dvhvir5ngdl76";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092447";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "101rlz9vzlxlklzpx78nx1c75rin4lhjjiz1grrlp9crvgwkvdri";
      type = "gem";
    };
    version = "3.0.0.dev.build20190404092447";
  };
