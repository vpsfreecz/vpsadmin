{
  ...
  libnodectld = {
    ...
    source = {
      ...
      sha256 = "0fyvr7dzjk7ppw1z0wipva5mrqzhqvxmljywhxb2ywl8x314gh6p";
      type = "gem";
    };
    version = "4.1.0.build20251008191815";
  };
  libosctl = {
    dependencies = [
      "fiddle"
  ...
  nodectld = {
    ...
    source = {
      remotes = [ "https://rubygems.vpsfree.cz" ];
      sha256 = "0z8qjzc0q3lqx3zdc89j5rdpzcdx4wimgs9689nlz3annnx2b8jr";
      type = "gem";
    };
    version = "4.1.0.build20251008191815";
  };
