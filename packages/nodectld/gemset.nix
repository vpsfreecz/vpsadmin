{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1apd9jp136dmsh3c6fj52gcyzd4f4dpym0j81s3v93dpismw6y5v";
      type = "gem";
    };
    version = "3.0.0.dev.build20200207182423";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1lqsqaqldzk1y3vpmzjv5psxng0cs70sblsfp9ky5d55fljw6qfd";
      type = "gem";
    };
    version = "3.0.0.dev.build20200207182423";
  };
