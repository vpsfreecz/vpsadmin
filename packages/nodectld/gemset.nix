{
  ...
  libnodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0qx1l54gb4p6rf2m3xgnzxafn4iahl9kcpyw9rbrmncra0260ngy";
      type = "gem";
    };
    version = "3.0.0.dev.build20220802154217";
  };
  libosctl = {
  ...
  nodectld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "0dn2axn8cm1qx2pq6n410id15q8zyysn82g5hx23i7mc0qb5yvi6";
      type = "gem";
    };
    version = "3.0.0.dev.build20220802154217";
  };
