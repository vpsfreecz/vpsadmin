{
  ...
  haveapi = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1i1iadil347hbz3v62zbz8pvs9vi40x83ycxwx1bb4bz3gvq93s0";
      type = "gem";
    };
    version = "0.17.0";
  };
  haveapi-client = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0rhcz9jcd88mip8a8q2fvxnnncl1viqcsah0arw7rpszyrx1x5sj";
      type = "gem";
    };
    version = "0.17.0";
  };
  ...
  net-imap = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1diq6szn3gkyv0hpp8gr7kwm2yj7167vmml872wdq4m9pk12hgfv";
      type = "gem";
    };
    version = "0.4.3";
  };
