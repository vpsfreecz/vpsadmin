{
  ...
  haveapi = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0wpn1asilpzc1yn3qbr9x7vpf1cfqjsx2vv52qqw2aw6jx1vqkrb";
      type = "gem";
    };
    version = "0.28.4";
  };
  haveapi-client = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0vw4ji7cjqajhmdbv38pczwwizlsxxdgb51mkxhzfzqks5sa2gm0";
      type = "gem";
    };
    version = "0.28.4";
  };
  ...
  rubocop = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "09jgk764f0cfka3qsyjfqcwqvidp42h3qbw5zz9rw5mwsrrzfskj";
      type = "gem";
    };
    version = "1.88.1";
  };
