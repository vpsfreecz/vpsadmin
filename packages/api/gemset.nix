{
  ...
  fio_api = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1k76lfrkv0p72v1bs16m7wgvzxcv4ba0icggnicr4ffcms6mzmsk";
      type = "gem";
    };
    version = "0.0.11";
  };
  haveapi = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "0l84syb3ajacshn56ihiq7ddyx8pp3m3n210mv16y0lpmjqqhrql";
      type = "gem";
    };
    version = "0.27.0";
  };
  haveapi-client = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "03blciddiam07mvw9ranmpx43khmj07w33japfjhzb68kxmzsqg6";
      type = "gem";
    };
    version = "0.27.0";
  };
  ...
  user_agent_parser = {
    ...
    source = {
      remotes = [ "https://rubygems.org" ];
      sha256 = "1isp7y7v8mc7ihlv6hsjksv1cd5csfbzwf10lscs8mcrmwadjifr";
      type = "gem";
    };
    version = "2.21.0";
  };
