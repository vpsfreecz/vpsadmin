...
testLib.makeTests [
  ...
  "v4/cluster/node-evacuate-basic"
  "v4/cluster/node-evacuate-concurrency"
  ...
  "v4/admin/nodectl-read-and-queue-control"
  "v4/admin/nodectl-refresh-and-runtime-state"
  "v4/admin/remote-mount-state"
  "v4/admin/location-network-primary-switch"
  "v4/alerts/incident-report-process"
  "v4/alerts/oom-report-notify-and-prune"
  "v4/alerts/lifetime-and-daily-report"
  "v4/tasks/auth-session-housekeeping"
  ...
  "v4/storage/branching-shared-snapshot-prune"
  "v4/storage/source-rotation-after-backup-prune"
  "v4/storage/branching-destroy"
  "v4/storage/snapshot-download-incremental-branch-mismatch"
  ...
  "v4/dns/server-zone-lifecycle"
  "v4/dns/secondary-transfer-errors"
  "v4/dns/zone-transfer-config"
  ...
  "v4/vps/migrate"
  "v4/vps/migrate-with-open-maintenance-window"
