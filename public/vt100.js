...
VT100.prototype.truncateLines = function (width) {
    ...
    for (var line = this.console[this.currentScreen].firstChild; line;
        ...
        if (line.tagName == 'DIV') {
            ...
            while (span &&
                span.className == 'ansi0 bgAnsi15' && !span.style.cssText.length) {
...
VT100.prototype.keyDown = function (event) {
    ...
    if ((event.charCode || event.keyCode) &&
        ((alphNumKey && (event.ctrlKey || event.altKey || event.metaKey) && !event.shiftKey &&
            ...
            this.catchModifiersEarly && normalKey && !alphNumKey &&
                (event.ctrlKey || event.altKey || event.metaKey) || !normalKey)) {
                    ...
                    if (ch == 0x3B) {
                        ...
                        switch (ch) {
                            ...
                            case 0x63:
                                ...
                                break;
                            /*m*/
                            case 0x6D: /* (re)set key modifier resource values */
                                break;
                            /*n*/
                            case 0x6E: /* disable key modifier resource values */
                                break;
                            /*p*/
                            case 0x70: /* set pointer mode resource value */
                                break;
                            default:
                                break;
                        }
...
VT100.prototype.vt100 = function (s) {
    ...
    for (var i = 0; i < s.length; i++) {
        ...
        var isNormalCharacter =
            (ch >= 32 && ch <= 127 || ch >= 160 ||
                this.utfEnabled && ch >= 128 || !(this.dispCtrl ? this.ctrlAlways : this.ctrlAction)[ch & 0x1F]) &&
