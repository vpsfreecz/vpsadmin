...
if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"]) {
    ...
    $xtpl->menu_add(_("Manage VPS"),'?page=adminvps', ($_GET["page"] ==
'adminvps'));
    $xtpl->menu_add(_("Manage Members"),'?page=adminm', ($_GET["page"] == 'adminm'));
    $xtpl->menu_add(_("Manage Networking"),'?page=networking', ($_GET["page"] == 'networking'));
    if ($_SESSION["is_admin"]) {
	$xtpl->menu_add(_("Manage Cluster"),'?page=cluster', ($_GET["page"] == 'cluster'));
    ...
    $xtpl->menu_add(_("Status"),'?page=', ($_GET["page"] == ''));
    $xtpl->menu_add(_("About vpsAdmin"),'?page=about', ($_GET["page"] ==
'about'), true);
}
