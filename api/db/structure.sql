...
CREATE TABLE `datasets` (
  ...
  `ancestry` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
  `ancestry_depth` int(11) NOT NULL DEFAULT 0,
  `expiration` datetime /* mariadb-5.3 */ DEFAULT NULL,
  `confirmed` int(11) NOT NULL DEFAULT 0,
  `object_state` int(11) NOT NULL,
  `expiration_date` datetime /* mariadb-5.3 */ DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `last_request_at` datetime /* mariadb-5.3 */ DEFAULT NULL,
  `current_login_at` datetime /* mariadb-5.3 */ DEFAULT NULL,
  `last_login_at` datetime /* mariadb-5.3 */ DEFAULT NULL,
  ...
  `last_activity_at` datetime /* mariadb-5.3 */ DEFAULT NULL,
