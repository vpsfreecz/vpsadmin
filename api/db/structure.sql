...
CREATE TABLE `mail_logs` (
  ...
  `text_plain` longtext COLLATE utf8_czech_ci DEFAULT NULL,
  `text_html` longtext COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `mail_template_translations` (
  ...
  `return_path` varchar(255) COLLATE utf8_czech_ci DEFAULT NULL,
  `subject` varchar(255) COLLATE utf8_czech_ci NOT NULL,
  `text_plain` text COLLATE utf8_czech_ci DEFAULT NULL,
  `text_html` text COLLATE utf8_czech_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `object_histories` (
  ...
  `event_data` text COLLATE utf8_czech_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `pools` (
  ...
  `migration_public_key` text COLLATE utf8_czech_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sysconfig` (
  ...
  `value` text COLLATE utf8_czech_ci DEFAULT NULL,
  `label` varchar(255) COLLATE utf8_czech_ci DEFAULT NULL,
  `description` text COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `transaction_confirmations` (
  ...
  `attr_changes` text COLLATE utf8_czech_ci DEFAULT NULL,
...
CREATE TABLE `transactions` (
  ...
  `done` int(11) NOT NULL DEFAULT 0,
  `input` longtext COLLATE utf8_czech_ci DEFAULT NULL,
  `output` text COLLATE utf8_czech_ci DEFAULT NULL,
  `transaction_chain_id` int(11) NOT NULL,
...
CREATE TABLE `versions` (
  ...
  `object` text COLLATE utf8_czech_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `vpses` (
  ...
  `info` mediumtext COLLATE utf8_czech_ci DEFAULT NULL,
