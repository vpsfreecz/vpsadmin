...
ActiveRecord::Schema[8.1].define(version: 2025_12_18_120000) do
  ...
  create_table "console_ports", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.integer "port", null: false
    t.bigint "vps_id"
    t.index ["port"], name: "index_console_ports_on_port", unique: true
    t.index ["vps_id"], name: "index_console_ports_on_vps_id"
  end
  ...
  create_table "iso_images", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "label", limit: 100, null: false
    t.string "name", limit: 100, null: false
    t.bigint "storage_pool_id", null: false
    t.datetime "updated_at", null: false
    t.index ["storage_pool_id"], name: "index_iso_images_on_storage_pool_id"
  end
  ...
  create_table "locations", id: { type: :integer, unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    ...
    t.string "remote_vnc_server", default: "", null: false
    t.datetime "updated_at", precision: nil
  end

  create_table "mac_addresses", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.string "addr", limit: 17, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["addr"], name: "index_mac_addresses_on_addr", unique: true
  end
  ...
  create_table "network_interfaces", id: { type: :integer, unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    ...
    t.integer "export_id"
    t.bigint "guest_mac_address_id"
    t.bigint "host_mac_address_id"
    ...
    t.index ["guest_mac_address_id"], name: "index_network_interfaces_on_guest_mac_address_id", unique: true
    t.index ["host_mac_address_id"], name: "index_network_interfaces_on_host_mac_address_id", unique: true
  ...
  create_table "os_families", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["os_id"], name: "index_os_families_on_os_id"
  end
  ...
  create_table "oses", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "storage_pools", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.integer "confirmed", default: 0, null: false
    t.datetime "created_at", null: false
    t.string "name", limit: 50, null: false
    t.bigint "node_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.bigint "uuid_id", null: false
    t.index ["node_id"], name: "index_storage_pools_on_node_id"
    t.index ["uuid_id"], name: "index_storage_pools_on_uuid_id", unique: true
  end

  create_table "storage_volumes", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.integer "confirmed", default: 0, null: false
    t.datetime "created_at", null: false
    t.string "filesystem", limit: 10, null: false
    t.integer "format", default: 0, null: false
    t.bigint "fs_total"
    t.bigint "fs_used"
    t.string "label", limit: 50, null: false
    ...
    t.bigint "user_id", null: false
    t.bigint "vps_id"
    t.index ["storage_pool_id"], name: "index_storage_volumes_on_storage_pool_id"
    t.index ["user_id"], name: "index_storage_volumes_on_user_id"
    t.index ["vps_id"], name: "index_storage_volumes_on_vps_id"
  end
  ...
  create_table "vnc_tokens", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.bigint "client_token_id"
    t.datetime "created_at", null: false
    t.datetime "expiration", null: false
    t.bigint "node_token_id"
    t.datetime "updated_at", null: false
    t.bigint "user_session_id", null: false
    t.bigint "vps_id", null: false
    t.index ["client_token_id"], name: "index_vnc_tokens_on_client_token_id", unique: true
    t.index ["node_token_id"], name: "index_vnc_tokens_on_node_token_id", unique: true
    t.index ["user_session_id"], name: "index_vnc_tokens_on_user_session_id"
    t.index ["vps_id"], name: "index_vnc_tokens_on_vps_id"
  end
  ...
  create_table "vps_current_statuses", id: { type: :integer, unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    ...
    t.bigint "io_read_requests"
    t.bigint "io_write_bytes"
    t.bigint "io_write_requests"
    t.boolean "is_running", null: false
    t.datetime "last_log_at"
    t.float "loadavg1"
    t.float "loadavg15"
    t.float "loadavg5"
    t.bigint "network_bytes"
    t.bigint "network_bytes_in"
    t.bigint "network_bytes_out"
    t.bigint "network_packets"
    t.bigint "network_packets_in"
    t.bigint "network_packets_out"
    t.integer "process_count"
    t.boolean "qemu_guest_agent", default: false, null: false
    t.string "state", limit: 20, default: "no_state", null: false
    ...
    t.float "sum_cpu_system"
    t.float "sum_cpu_user"
    t.bigint "sum_io_read_bytes"
    t.bigint "sum_io_read_requests"
    t.bigint "sum_io_write_bytes"
    t.bigint "sum_io_write_requests"
    t.float "sum_loadavg1"
    t.float "sum_loadavg15"
    t.float "sum_loadavg5"
    t.bigint "sum_network_bytes"
    t.bigint "sum_network_bytes_in"
    t.bigint "sum_network_bytes_out"
    t.bigint "sum_network_packets"
    t.bigint "sum_network_packets_in"
    t.bigint "sum_network_packets_out"
    t.integer "sum_process_count"
    ...
    t.integer "used_swap"
    t.integer "vps_id", null: false
    t.index ["state"], name: "index_vps_current_statuses_on_state"
  ...
  create_table "vps_io_stat_logs", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "fs_total"
    t.bigint "fs_used"
    t.bigint "read_bytes", default: 0, null: false
    t.bigint "read_requests", default: 0, null: false
    t.bigint "storage_volume_id", null: false
    t.datetime "updated_at", null: false
    t.bigint "vps_id", null: false
    t.bigint "write_bytes", default: 0, null: false
    t.bigint "write_requests", default: 0, null: false
    t.index ["storage_volume_id"], name: "index_vps_io_stat_logs_on_storage_volume_id"
    t.index ["vps_id"], name: "index_vps_io_stat_logs_on_vps_id"
  end

  create_table "vps_io_stats", charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "delta", default: 1, null: false
    t.bigint "read_bytes", default: 0, null: false
    t.bigint "read_bytes_readout", default: 0, null: false
    t.bigint "read_requests", default: 0, null: false
    t.bigint "read_requests_readout", default: 0, null: false
    t.bigint "storage_volume_id", null: false
    t.bigint "sum_read_bytes", default: 0, null: false
    t.bigint "sum_read_requests", default: 0, null: false
    t.bigint "sum_write_bytes", default: 0, null: false
    t.bigint "sum_write_requests", default: 0, null: false
    t.datetime "updated_at", null: false
    t.bigint "vps_id", null: false
    t.bigint "write_bytes", default: 0, null: false
    t.bigint "write_bytes_readout", default: 0, null: false
    t.bigint "write_requests", default: 0, null: false
    t.bigint "write_requests_readout", default: 0, null: false
    t.index ["storage_volume_id"], name: "index_vps_io_stats_on_storage_volume_id"
    t.index ["vps_id", "storage_volume_id"], name: "index_vps_io_stats_on_vps_id_and_storage_volume_id", unique: true
    t.index ["vps_id"], name: "index_vps_io_stats_on_vps_id"
  end
  ...
  create_table "vps_statuses", id: { type: :integer, unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    ...
    t.integer "used_swap"
    t.integer "vps_id", null: false
    t.index ["state"], name: "index_vps_statuses_on_state"
  ...
  create_table "vpses", id: { type: :integer, unsigned: true }, charset: "utf8mb3", collation: "utf8mb3_czech_ci", force: :cascade do |t|
    ...
    t.bigint "os_family_id", null: false
    t.integer "os_template_id", unsigned: true
    t.datetime "remind_after_date", precision: nil
    t.bigint "rescue_volume_id"
    t.integer "start_menu_timeout", default: 5
    t.bigint "storage_volume_id"
    t.datetime "updated_at", precision: nil
    ...
    t.index ["console_port_id"], name: "index_vpses_on_console_port_id", unique: true
    ...
    t.index ["iso_image_id"], name: "index_vpses_on_iso_image_id"
    ...
    t.index ["os_family_id"], name: "index_vpses_on_os_family_id"
    t.index ["os_template_id"], name: "index_vpses_on_os_template_id"
    t.index ["rescue_volume_id"], name: "index_vpses_on_rescue_volume_id"
    t.index ["storage_volume_id"], name: "index_vpses_on_storage_volume_id"
    t.index ["user_id"], name: "index_vpses_on_user_id"
    t.index ["user_namespace_map_id"], name: "index_vpses_on_user_namespace_map_id"
    t.index ["uuid_id"], name: "index_vpses_on_uuid_id", unique: true
    t.index ["vm_type"], name: "index_vpses_on_vm_type"
  end
