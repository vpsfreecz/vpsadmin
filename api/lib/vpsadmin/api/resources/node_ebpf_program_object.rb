module VpsAdmin::API::Resources
  class NodeEbpfProgramObject < HaveAPI::Resource
    model ::NodeEbpfProgramObject
    desc 'Kernel-visible BPF object names used by Node eBPF mitigations'
    ...
    class Index < HaveAPI::Actions::Default::Index
      ...
      def query
        scope = ::NodeEbpfProgramObject.joins(
