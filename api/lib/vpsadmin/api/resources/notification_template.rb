module VpsAdmin::API::Resources
  class NotificationTemplate < HaveAPI::Resource
    ...
    class Recipient < HaveAPI::Resource
      model ::NotificationTemplateEmailRecipient
      route '{notification_template_id}/email_recipients'
      desc 'Manage email recipients'

      params(:common) do
        resource VpsAdmin::API::Resources::EmailRecipient
      end
      ...
      class Index < HaveAPI::Actions::Default::Index
        ...
        def query
          ::NotificationTemplateEmailRecipient.where(notification_template_id: path_params['notification_template_id'])
        end
      ...
      class Show < HaveAPI::Actions::Default::Show
        ...
        def prepare
          @r = ::NotificationTemplateEmailRecipient.find_by!(
            notification_template_id: path_params['notification_template_id'],
            email_recipient_id: path_params['recipient_id']
          )
        end
      ...
      class Create < HaveAPI::Actions::Default::Create
        ...
        input do
          use :common
          patch :email_recipient, required: true
        end
        ...
        def exec
          ...
          r = ::NotificationTemplateEmailRecipient.new(
      ...
      class Delete < HaveAPI::Actions::Default::Delete
        ...
        def exec
          ::NotificationTemplateEmailRecipient.find_by!(
            notification_template_id: path_params['notification_template_id'],
            email_recipient_id: path_params['recipient_id']
          ).destroy
          ok!
