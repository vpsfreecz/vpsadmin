class VpsAdmin::API::Resources::VPS < HaveAPI::Resource
  ...
  params(:vps_user_data) do
    ...
    string :user_data_format, choices: ::VpsUserData.formats.keys.map(&:to_s)
    text :user_data_content
  end
  ...
  class Create < HaveAPI::Actions::Default::Create
    ...
    authorize do |u|
      ...
      input whitelist: %i[
        ...
        user_namespace_map start user_data user_data_format user_data_content
      ]
      output whitelist: %i[
        id user hostname manage_hostname os_template cgroup_version dns_resolver
        node dataset pool memory swap cpu diskspace maintenance_lock
    ...
    def exec
      ...
      %i[start user_data user_data_format user_data_content].each do |v|
